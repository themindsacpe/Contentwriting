                    ...
                    <tr>
                        ...
                        <td>
                            <div class="table-actions">
                                ...
                                <button class="btn btn-danger btn-sm" onclick="deleteCustomer('${customer.id || customer.userId}')" title="Delete Customer">
                                    <i class="fas fa-trash"></i>
                                </button>
                            </div>
                        </td>
